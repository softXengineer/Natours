...
var stripe = Stripe('pk_test_51KMXIJGG0YRkuCQl1DqfBCddkVEbd4zDvF1CmpFd38XpvqEoPzhJkH7OyAH1JFYwqHsrmKpnJIbKK6djM3X4v3jb00btiX6COY');
...
var formBtn = document.querySelector('.btn__form--save');
var bookToorBtn = document.getElementById('book-tour');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8259" + '/');
